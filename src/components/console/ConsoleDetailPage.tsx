...
const ConsoleDetailPage = () => {
  ...
  const { minimum, recommended } = consoleDetail?.requirements || {};
        ...
        <div className="h-dvh" id="clip_gd">
          <div className="mask-clip-gd game_image absolute left-1/2 top-0 z-20 h-[80vh] w-96 origin-center -translate-x-1/2 overflow-hidden rounded-3xl md:w-[60vw] ">
            <img
              ...
              src={consoleDetail?.image}
              alt={`Image of ${consoleDetail?.name}`}
            />
          </div>
        </div>
            ...
            <div className="flex gap-8 max-w-4xl">
              ...
              "
                  >
                    ...
                    <div className="flex flex-col gap-[2px] items-end">
                      {consoleDetail?.devices.map((device: any) => (
                        <span
                          key={device}
              ...
              "
                  >
                    ...
                    <div className="flex flex-col gap-[2px] items-end">
                      {consoleDetail?.category?.map((cat) => {
                        return (
                          <span
                            key={cat}
